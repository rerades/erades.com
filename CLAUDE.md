...
- **Writing a new post**: follow the `nuevo-articulo` skill in `.claude/skills/nuevo-articulo/SKILL.md` (paths, frontmatter, SVG diagrams, bibliography, hero, visual baselines, PR). It is a living document: every article PR updates it with what was learned.
