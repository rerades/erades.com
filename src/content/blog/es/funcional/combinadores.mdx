...
categories:
  - functional
translationKey: "functional/combinators"
draft: false
...
<ul>
<li>Programación Funcional en JavaScript . Ed: MANNING SHELTER ISLAND. Autor: Luis Atencio.<br /></li>
<li><a href="https://drboolean.gitbooks.io/mostly-adequate-guide-old/content/">Guía Más Que Adecuada para la programación funcional</a>. Professor Frisby's<br /></li>
<li><a href="https://www.packtpub.com/web-development/building-declarative-apps-using-functional-javascript-video">Creando una aplicación declarativa usando JavaScript funcional</a>. Michael Rosata</li>
</ul>
</div>
