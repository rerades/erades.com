...
<li><a href="https://drboolean.gitbooks.io/mostly-adequate-guide-old/content/">Guía Más Que Adecuada para la programación funcional</a>. Professor Frisby's</li>
<li>Creando una aplicación declarativa usando JavaScript funcional (curso en vídeo de Packt, ya no está disponible). Michael Rosata</li>
</ul>
</div>
