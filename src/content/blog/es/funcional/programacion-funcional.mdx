...
categories:
  - functional
translationKey: "functional/functional-programming"
draft: false
...
<li><a href="https://www.pluralsight.com/courses/javascript-functional-programming-fundamentals">Fundamentos de la Programación Funcional en JavaScript</a>. Nate Taylor (Pluralsight)</li>
<li><a href="https://www.w3schools.com/jsref/jsref_obj_array.asp">Referencia del Array en JavaScript</a>. W3Schools</li>
</ul>
</div>
