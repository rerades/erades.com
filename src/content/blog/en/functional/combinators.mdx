...
<ul>
<li>Functional Programming in JavaScript. Ed: MANNING SHELTER ISLAND. Author: Luis Atencio.</li>
<li><a href="https://drboolean.gitbooks.io/mostly-adequate-guide-old/content/">Mostly Adequate Guide to functional programming</a>. Professor Frisby's</li>
<li>Building Declarative Apps using Functional JavaScript (Packt video course, no longer online). Michael Rosata</li>
</ul>
</div>
