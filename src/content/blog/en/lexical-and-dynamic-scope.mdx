...
categories:
  - javascript
translationKey: "lexical-and-dynamic-scope"
draft: false
...
We can cheat on lexical scoping using eval keyword. <br />
...
<ul>
<li><a href="https://stackoverflow.com/questions/36383795/javascript-lhs-and-rhs-lookup">JavaScript LHS and RHS Lookup</a>. Stack Overflow</li>
<li>Advanced JavaScript (Pluralsight course). Kyle Simpson</li>
</ul>
</div>
