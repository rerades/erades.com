...
categories:
  - javascript
  - functional
translationKey: "statement-branching-vs-micro-branching"
draft: false
...
<ul>
<li><a href="https://javascriptweblog.wordpress.com/2010/07/26/no-more-ifs-alternatives-to-statement-branching-in-javascript/">No ifs…alternatives to statement branching in JavaScript</a>. Angus Croll</li>
</ul>
</div>
