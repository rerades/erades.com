...
categories:
  - design patterns
translationKey: "patterns/testing-protoype-inheritance"
draft: false
...
<ul>
<li><a href="https://stackoverflow.com/questions/53406070/using-call-to-inherit-objects-from-a-function">using Call to inherit objects from a function</a>. Stack Overflow</li>
</ul>
</div>
